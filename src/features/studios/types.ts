...
export type Studio = {
  ...
  collections: { name: string; note: string; image: string; slug?: string }[];
  journal: { title: string; date: string; image: string; slug?: string }[];
  videos: { title: string; duration: string; image: string; slug?: string }[];
  achievement: string;
